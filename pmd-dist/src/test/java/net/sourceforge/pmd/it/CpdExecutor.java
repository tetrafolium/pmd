...
public class CpdExecutor {
    ...
    private static ExecutionResult runCpdUnix(final Path tempDir, final String... arguments) throws Exception {
    ...
    private static ExecutionResult runCpdWindows(final Path tempDir, final String... arguments) throws Exception {
     ...
     */
    public static ExecutionResult runCpd(final Path tempDir, final String... arguments) throws Exception {
