...
public class PLSQLParser extends AbstractParser {
    public PLSQLParser(final ParserOptions parserOptions) {
        super(parserOptions);
    }
     ...
     */
    protected net.sourceforge.pmd.lang.plsql.ast.PLSQLParser createPLSQLParser(final Reader source) throws ParseException {
