...
public class JUnitAssertionsShouldIncludeMessageRule extends AbstractJUnitRule {
    ...
    private class AssertionCall {
        ...
        AssertionCall(final String assertionName, final int argumentsCount) {
            this.argumentsCount = argumentsCount;
            this.assertionName = assertionName;
        }

        public void check(final Object ctx, final ASTArguments node) {
        ...
        protected boolean isException(final ASTArguments node) {
            return false;
        }
    }
     ...
     */
    private boolean isStringTypeOrNull(final ASTExpression node) {
